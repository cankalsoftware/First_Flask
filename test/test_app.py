...
def test_hello_template_with_name(client):
    ...
    assert b"<h1>Hello, Alice!</h1>" in response.data  # Check for the h1 tag instead of plain text
    assert b"Today's date and time is:" in response.data  # Also check for the date and time part
...
def test_hello_template_no_name(client):
    ...
    assert b"<h1>Hello, Friend!</h1>" in response.data  # Check for the h1 tag instead of plain text
    assert b"Today's date and time is:" in response.data  # Also check for the date and time part
